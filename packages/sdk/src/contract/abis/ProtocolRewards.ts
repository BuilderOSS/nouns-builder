export const protocolRewardsAbi = [
  ...
  { inputs: [], name: 'INVALID_DEPOSIT', type: 'error' },
  { inputs: [], name: 'INVALID_SIGNATURE', type: 'error' },
  { inputs: [], name: 'INVALID_WITHDRAW', type: 'error' },
  { inputs: [], name: 'InvalidShortString', type: 'error' },
  { inputs: [], name: 'SIGNATURE_DEADLINE_EXPIRED', type: 'error' },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'zora', type: 'address' },
