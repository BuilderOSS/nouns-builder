...
export type ClankerTokenHolderFragment = { __typename?: 'ClankerTokenHolder', id: string, holder: any, balance: any, updatedAt: any, updatedAtBlock: any, token: { __typename?: 'ClankerToken', tokenAddress: any, tokenName: string, tokenSymbol: string, tokenImage: string } };

export type ClankerTokenWithHoldersFragment = { __typename?: 'ClankerToken', pairedToken: any, poolId: any, poolHook: any, createdAt: any, transactionHash: any, msgSender: any, tokenAddress: any, tokenName: string, tokenSymbol: string, tokenImage: string, holders: Array<{ __typename?: 'ClankerTokenHolder', id: string, holder: any, balance: any, updatedAt: any }>, dao?: { __typename?: 'DAO', id: string, name: string, contractImage: string } | null };
...
export type DaoFragment = { __typename?: 'DAO', name: string, contractImage: string, tokenAddress: any, metadataAddress: any, treasuryAddress: any, auctionAddress: any, governorAddress: any, links: Array<{ __typename?: 'DAOLink', key: string, url: string }> };
...
export type ClankerTokenHolderQuery = { __typename?: 'Query', clankerTokenHolder?: { __typename?: 'ClankerTokenHolder', id: string, holder: any, balance: any, updatedAt: any, updatedAtBlock: any, token: { __typename?: 'ClankerToken', tokenAddress: any, tokenName: string, tokenSymbol: string, tokenImage: string } } | null };
...
export type ClankerTokenHoldersQuery = { __typename?: 'Query', clankerTokenHolders: Array<{ __typename?: 'ClankerTokenHolder', id: string, holder: any, balance: any, updatedAt: any, updatedAtBlock: any, token: { __typename?: 'ClankerToken', tokenAddress: any, tokenName: string, tokenSymbol: string, tokenImage: string } }> };
...
export type ClankerTokenWithHoldersQuery = { __typename?: 'Query', clankerToken?: { __typename?: 'ClankerToken', pairedToken: any, poolId: any, poolHook: any, createdAt: any, transactionHash: any, msgSender: any, tokenAddress: any, tokenName: string, tokenSymbol: string, tokenImage: string, holders: Array<{ __typename?: 'ClankerTokenHolder', id: string, holder: any, balance: any, updatedAt: any }>, dao?: { __typename?: 'DAO', id: string, name: string, contractImage: string } | null } | null };
...
export type DaoOgMetadataQuery = { __typename?: 'Query', dao?: { __typename?: 'DAO', name: string, description: string, contractImage: string, totalSupply: number, ownerCount: number, proposalCount: number, tokenAddress: any, metadataAddress: any, auctionAddress: any, treasuryAddress: any, governorAddress: any, links: Array<{ __typename?: 'DAOLink', key: string, url: string }> } | null };
...
export type DaoVotersQuery = { __typename?: 'Query', daovoters: Array<{ __typename?: 'DAOVoter', id: string, voter: any, daoTokenCount: number, daoTokens: Array<{ __typename?: 'Token', tokenId: any, mintedAt: any }> }> };
...
export type DaosForUserQuery = { __typename?: 'Query', daos: Array<{ __typename?: 'DAO', name: string, contractImage: string, tokenAddress: any, metadataAddress: any, treasuryAddress: any, auctionAddress: any, governorAddress: any, links: Array<{ __typename?: 'DAOLink', key: string, url: string }> }> };
...
export type UserProposalVoteQuery = { __typename?: 'Query', proposalVotes: Array<{ __typename?: 'ProposalVote', voter: any, support: ProposalVoteSupport, weight: number, reason?: string | null }> };
...
export const ClankerTokenHoldersDocument = gql`
    query ClankerTokenHolders($where: ClankerTokenHolder_filter, $first: Int = 100, $skip: Int = 0, $orderBy: ClankerTokenHolder_orderBy = updatedAt, $orderDirection: OrderDirection = desc) {
  clankerTokenHolders(
    where: $where
    first: $first
    skip: $skip
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    ClankerTokenHolder(variables: ClankerTokenHolderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ClankerTokenHolderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClankerTokenHolderQuery>({ document: ClankerTokenHolderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ClankerTokenHolder', 'query', variables);
    },
    ClankerTokenHolders(variables?: ClankerTokenHoldersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ClankerTokenHoldersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClankerTokenHoldersQuery>({ document: ClankerTokenHoldersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ClankerTokenHolders', 'query', variables);
    },
    clankerTokenWithHolders(variables: ClankerTokenWithHoldersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ClankerTokenWithHoldersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClankerTokenWithHoldersQuery>({ document: ClankerTokenWithHoldersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'clankerTokenWithHolders', 'query', variables);
    },
