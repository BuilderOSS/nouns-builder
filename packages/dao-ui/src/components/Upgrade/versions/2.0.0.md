...
_Voting yes on this proposal confirms that you have read the [Builder Protocol Rewards documentation](https://docs.nouns.build/guides/builder-protocol-rewards) and understand how Protocol Rewards apply to this DAO._
