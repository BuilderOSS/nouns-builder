...
// Conditional import for RainbowKit
let useConnectModal: () => { openConnectModal?: () => void }

try {
  // Try to import RainbowKit hook
  const rainbowkit = require('@rainbow-me/rainbowkit')
  useConnectModal = rainbowkit.useConnectModal
} catch {
  // RainbowKit not available, create fallback
  useConnectModal = () => ({ openConnectModal: undefined })
}
